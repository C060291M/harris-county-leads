...
travis_job = """
  travis:
    ...
    steps:
      ...
      - name: Run Travis County scraper
        run: python scraper/multi_county_travis.py
        env:
...
content = content.replace("  enrich-esearch:", travis_job + "  enrich-esearch:")
content = content.replace(
    "needs: [harris, dallas-bexar, tarrant, collin,",
    "needs: [harris, dallas-bexar, tarrant, collin, travis,"
)
