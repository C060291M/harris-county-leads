...
COUNTIES = {
    ...
    "Grayson":  "grayson.tx.publicsearch.us",

    "Brewster": "brewster.tx.publicsearch.us",

    "Coleman":  "coleman.tx.publicsearch.us",

    "Goliad":   "goliad.tx.publicsearch.us",

    "Hockley":  "hockley.tx.publicsearch.us",

    "Reagan":   "reagan.tx.publicsearch.us",

    "Reeves":   "reeves.tx.publicsearch.us",

    "Young":    "young.tx.publicsearch.us",
    ...
    async with async_playwright() as p:
        ...
        for doc_type, cat, cat_label in DOC_TYPES:
            ...
            try:
                ...
                await page.goto(f"{base}/search/advanced", wait_until="domcontentloaded", timeout=30000)
...
async def main_async():
    ...
    with open("dashboard/multi_county_10_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_10_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_10_records.json")
