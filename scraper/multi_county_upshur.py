"""
StackIQ — Upshur County Scraper (Tyler iDS Self Service Web)
...
BASE_URL      = "https://upshurtx-web.tylerhost.net/web"
...
async def main_async():
    ...
    log.info("=== Upshur County Scraper ===")
    ...
    with open("dashboard/upshur_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/upshur_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
