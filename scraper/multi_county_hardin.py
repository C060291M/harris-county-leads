"""
StackIQ — Hardin County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Hardin County Scraper ===")
    ...
    with open("dashboard/hardin_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/hardin_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
