    ...
    async with async_playwright() as p:
        ...
        for doc_type, cat, cat_label in DOC_TYPES:
            ...
            try:
                ...
                # Step 2: Fill date range - try instrumentDateRange first (works on all counties), fall back to recordedDateRange
...
async def main_async():
    ...
    with open("dashboard/multi_county_2_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_2_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_2_records.json")
