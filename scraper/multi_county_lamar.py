"""
StackIQ — Lamar County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    with open("dashboard/lamar_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/lamar_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
