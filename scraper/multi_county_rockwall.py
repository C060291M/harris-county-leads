"""
StackIQ — Rockwall County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Rockwall County Scraper ===")
    ...
    with open("dashboard/rockwall_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/rockwall_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
