...
log = logging.getLogger("rockwall")
...
BASE_URL      = "https://rockwalltx-web.tylerhost.net/web"
...
async def scrape_rockwall(start_dt, end_dt):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            log.warning("Rockwall: disclaimer error: %s", e)
        ...
        for page_num in range(1, MAX_PAGES + 1):
            ...
            try:
                ...
                log.info("Rockwall: %d raw items", len(items))
                ...
                log.info("Rockwall: page %d found %d distress records", page_num, page_records)
                ...
                log.warning("Rockwall: page %d error: %s", page_num, e)
...
async def main_async():
    ...
    all_records = await scrape_rockwall(cutoff, now)
    ...
    payload = {
        ...
        "source": "Rockwall County Clerk (Tyler iDS)",
    ...
    with open("dashboard/rockwall_records.json","w") as f: json.dump(payload,f,indent=2,default=str)

    with open("data/rockwall_records.json","w") as f: json.dump(payload,f,indent=2,default=str)

    log.info("Saved -> dashboard/rockwall_records.json")
