...
async def main_async():
    ...
    with open("dashboard/multi_county_15_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_15_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_15_records.json")
