...
COUNTIES = {
    ...
    "Rusk": "rusk.tx.publicsearch.us",

    "Panola": "panola.tx.publicsearch.us",

    "Cherokee": "cherokee.tx.publicsearch.us",

    "Houston": "houston.tx.publicsearch.us",

    "Trinity": "trinity.tx.publicsearch.us",
...
async def main_async():
    ...
    with open("dashboard/multi_county_12_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_12_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_12_records.json")
