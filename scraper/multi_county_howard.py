"""
StackIQ — Howard County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Howard County Scraper ===")
    ...
    with open("dashboard/howard_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/howard_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
