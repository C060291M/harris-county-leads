...
COUNTIES = {
    ...
    "Bee":     "bee.tx.publicsearch.us",

    "Midland": "midland.tx.publicsearch.us",

    "Potter":  "potter.tx.publicsearch.us",

    "Cameron": "cameron.tx.publicsearch.us",
...
async def main_async():
    ...
    with open("dashboard/multi_county_5_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_5_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_5_records.json")
