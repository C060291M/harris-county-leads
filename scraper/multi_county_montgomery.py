...
BASE_URL      = "https://montgomerycountytx-web.tylerhost.net/web"
...
async def scrape_ector(start_dt, end_dt):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            log.warning("Montgomery: disclaimer error: %s", e)
        ...
        for page_num in range(1, MAX_PAGES + 1):
            ...
            log.info("Montgomery: page %d of %d (%s to %s)", page_num, MAX_PAGES, start_str, end_str)
            ...
            try:
                ...
                log.info("Montgomery: %d raw items", len(items))
                ...
                log.info("Montgomery: page %d found %d distress records", page_num, page_records)
                ...
                log.warning("Montgomery: page %d error: %s", page_num, e)
...
async def main_async():
    ...
    log.info("=== Montgomery County Scraper (Tyler iDS) (optimized) ===")
    ...
    with open("dashboard/montgomery_records.json","w") as f: json.dump(payload,f,indent=2,default=str)

    with open("data/montgomery_records.json","w") as f: json.dump(payload,f,indent=2,default=str)
