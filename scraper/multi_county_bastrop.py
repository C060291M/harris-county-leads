"""
StackIQ — Bastrop County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Bastrop County Scraper ===")
    ...
    with open("dashboard/bastrop_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/bastrop_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
