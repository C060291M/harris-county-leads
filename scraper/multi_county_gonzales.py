"""
StackIQ — Gonzales County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Gonzales County Scraper ===")
    ...
    with open("dashboard/gonzales_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/gonzales_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
