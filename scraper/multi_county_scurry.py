...
BASE_URL      = "https://scurrycountytx-web.tylerhost.net/web"
...
async def scrape_ector(start_dt, end_dt):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            log.warning("Scurry: disclaimer error: %s", e)
        ...
        for page_num in range(1, MAX_PAGES + 1):
            ...
            log.info("Scurry: page %d of %d (%s to %s)", page_num, MAX_PAGES, start_str, end_str)
            ...
            try:
                ...
                log.info("Scurry: %d raw items", len(items))
                ...
                log.info("Scurry: page %d found %d distress records", page_num, page_records)
                ...
                log.warning("Scurry: page %d error: %s", page_num, e)
...
async def main_async():
    ...
    log.info("=== Scurry County Scraper (Tyler iDS) (optimized) ===")
    ...
    with open("dashboard/scurry_records.json","w") as f: json.dump(payload,f,indent=2,default=str)

    with open("data/scurry_records.json","w") as f: json.dump(payload,f,indent=2,default=str)

    log.info("Saved -> dashboard/scurry_records.json")
