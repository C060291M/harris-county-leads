"""
StackIQ — Orange County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Orange County Scraper ===")
    ...
    with open("dashboard/orange_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/orange_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
