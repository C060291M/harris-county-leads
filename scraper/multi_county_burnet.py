"""
StackIQ — Burnet County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Burnet County Scraper ===")
    ...
    with open("dashboard/burnet_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/burnet_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
