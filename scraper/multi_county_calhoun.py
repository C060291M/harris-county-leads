"""
StackIQ — Calhoun County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Calhoun County Scraper ===")
    ...
    with open("dashboard/calhoun_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/calhoun_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
