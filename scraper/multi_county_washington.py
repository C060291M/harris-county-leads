...
BASE_URL      = "https://washingtoncountytx-web.tylerhost.net/web"
...
async def scrape_ector(start_dt, end_dt):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            log.warning("Washington: disclaimer error: %s", e)
        ...
        for page_num in range(1, MAX_PAGES + 1):
            ...
            log.info("Washington: page %d of %d (%s to %s)", page_num, MAX_PAGES, start_str, end_str)
            ...
            try:
                ...
                log.info("Washington: %d raw items", len(items))
                ...
                log.info("Washington: page %d found %d distress records", page_num, page_records)
                ...
                log.warning("Washington: page %d error: %s", page_num, e)
...
async def main_async():
    ...
    log.info("=== Washington County Scraper (Tyler iDS) (optimized) ===")
    ...
    with open("dashboard/washington_records.json","w") as f: json.dump(payload,f,indent=2,default=str)

    with open("data/washington_records.json","w") as f: json.dump(payload,f,indent=2,default=str)

    log.info("Saved -> dashboard/washington_records.json")
