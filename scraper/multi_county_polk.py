"""
StackIQ — Polk County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    with open("dashboard/polk_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/polk_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
