"""
StackIQ — Navarro County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Navarro County Scraper ===")
    ...
    with open("dashboard/navarro_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/navarro_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
