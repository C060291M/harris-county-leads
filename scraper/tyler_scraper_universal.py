...
COUNTY_REGISTRY = {
    ...
    # "Bastrop": moved to multi_county_bastrop.py (Aumentum portal)                 "DOCSEARCH144S1"),
    ...
    "Comal":       ("ROAM_NO_PORTAL",             "DOCSEARCH144S1"),
    ...
    # "Gregg": moved to multi_county_gregg.py (Aumentum at aumentumpa.greggcounty.texas.gov),             "DOCSEARCH144S1"),
    "Guadalupe":   ("ROAM_NO_PORTAL",         "DOCSEARCH144S1"),
