"""
StackIQ — Bowie County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    with open("dashboard/bowie_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/bowie_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
