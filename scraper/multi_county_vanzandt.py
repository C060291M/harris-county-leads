"""
StackIQ — VanZandt County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== VanZandt County Scraper ===")
    ...
    with open("dashboard/vanzandt_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/vanzandt_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
