"""
StackIQ — Gregg County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    with open("dashboard/gregg_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/gregg_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
