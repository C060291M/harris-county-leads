"""
StackIQ — Winkler County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Winkler County Scraper ===")
    ...
    with open("dashboard/winkler_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/winkler_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
