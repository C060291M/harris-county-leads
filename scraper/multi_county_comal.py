"""
StackIQ — Comal County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    with open("dashboard/comal_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/comal_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
