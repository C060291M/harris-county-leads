"""
StackIQ — McLennan County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== McLennan County Scraper ===")
    ...
    with open("dashboard/mclennan_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/mclennan_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
