"""
StackIQ — Somervell County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Somervell County Scraper ===")
    ...
    with open("dashboard/somervell_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/somervell_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
