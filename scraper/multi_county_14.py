...
COUNTIES = {
    ...
    "Victoria": "victoria.tx.publicsearch.us",

    "Calhoun": "calhoun.tx.publicsearch.us",

    "Jackson": "jackson.tx.publicsearch.us",

    "Wharton": "wharton.tx.publicsearch.us",

    "Lavaca": "lavaca.tx.publicsearch.us",
...
async def main_async():
    ...
    with open("dashboard/multi_county_14_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_14_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_14_records.json")
