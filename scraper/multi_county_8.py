...
COUNTIES = {
    ...
    "Walker": "walker.tx.publicsearch.us",

    "Madison": "madison.tx.publicsearch.us",

    "Matagorda": "matagorda.tx.publicsearch.us",

    "Refugio": "refugio.tx.publicsearch.us",

    "Starr": "starr.tx.publicsearch.us",
...
async def main_async():
    ...
    with open("dashboard/multi_county_8_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_8_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_8_records.json")
