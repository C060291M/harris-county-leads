"""
StackIQ — PaloPinto County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== PaloPinto County Scraper ===")
    ...
    with open("dashboard/palopinto_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/palopinto_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
