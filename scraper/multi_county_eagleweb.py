...
async def main_async():
    ...
    payload = {
        ...
        "source": "Tyler EagleWeb (countygovernmentrecords.com)",
    ...
    with open("dashboard/eagleweb_records.json", "w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/eagleweb_records.json", "w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/eagleweb_records.json")
