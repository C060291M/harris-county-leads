"""
StackIQ — Andrews County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Andrews County Scraper ===")
    ...
    with open("dashboard/andrews_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/andrews_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
