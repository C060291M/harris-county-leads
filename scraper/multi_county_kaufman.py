"""
StackIQ — Kaufman County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Kaufman County Scraper ===")
    ...
    with open("dashboard/kaufman_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/kaufman_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
