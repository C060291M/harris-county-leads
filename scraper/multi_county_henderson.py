"""
StackIQ — Henderson County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Henderson County Scraper ===")
    ...
    with open("dashboard/henderson_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/henderson_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
