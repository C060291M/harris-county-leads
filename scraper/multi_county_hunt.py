"""
StackIQ — Hunt County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    with open("dashboard/hunt_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/hunt_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
