"""
StackIQ — Eastland County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Eastland County Scraper ===")
    ...
    with open("dashboard/eastland_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/eastland_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
