"""
StackIQ — Karnes County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Karnes County Scraper ===")
    ...
    with open("dashboard/karnes_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/karnes_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
