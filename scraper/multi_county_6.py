...
COUNTIES = {
    ...
    "Wilson":      "wilson.tx.publicsearch.us",

    "Milam":       "milam.tx.publicsearch.us",

    "Johnson":     "johnson.tx.publicsearch.us",

    "Anderson":    "anderson.tx.publicsearch.us",

    "Nacogdoches": "nacogdoches.tx.publicsearch.us",
...
async def main_async():
    ...
    with open("dashboard/multi_county_6_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    with open("data/multi_county_6_records.json","w") as f:

        json.dump(payload, f, indent=2, default=str)

    log.info("Saved -> dashboard/multi_county_6_records.json")
