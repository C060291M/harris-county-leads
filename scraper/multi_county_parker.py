"""
StackIQ — Parker County Scraper (Fidlar AVA Web)
Portal: ava.fidlar.com/TXParker/AvaWeb/#/search
        ...
        for row in rows[1:]:
            ...
            try:
                ...
                records.append({
                    ...
                    "amount": None,
                    "legal": legals,
                    "clerk_url": f"https://ava.fidlar.com/TXParker/AvaWeb/#/docdetail/{doc_num}",
                    "county": "Parker",
...
async def main_async():
    ...
    log.info("=== Parker County Scraper ===")
    ...
    payload = {
        ...
        "source": "Parker County Clerk (Fidlar AVA Web)",
    ...
    with open("dashboard/parker_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/parker_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    log.info("Saved -> dashboard/parker_records.json")
