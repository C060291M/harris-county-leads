"""
StackIQ — Hood County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    with open("dashboard/hood_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/hood_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
