"""
StackIQ — Guadalupe County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Guadalupe County Scraper ===")
    ...
    with open("dashboard/guadalupe_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/guadalupe_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
