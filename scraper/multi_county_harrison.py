"""
StackIQ — Harrison County Scraper (Tyler iDS Self Service Web)
...
async def main_async():
    ...
    log.info("=== Harrison County Scraper ===")
    ...
    with open("dashboard/harrison_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
    with open("data/harrison_records.json", "w") as f:
        json.dump(payload, f, indent=2, default=str)
