...
fort_bend_job = """
  fort-bend:
    ...
    steps:
      ...
      - name: Run Fort Bend County scraper (Aumentum)
        run: python scraper/multi_county_fort_bend.py
        env:
...
content = content.replace("  enrich-esearch:", fort_bend_job + "  enrich-esearch:")
